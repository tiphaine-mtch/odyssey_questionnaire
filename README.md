# 🤝 Outil Collaboratif Experts - Odyssey PMS
...
Système collaboratif pour collecter, consolider et valider les réponses des experts opérationnels (resorts, business units, siège) sur les 48 questions en suspens concernant les règles métier du PMS Odyssey.
...
├── odyssey-questionnaire-experts.html      # Interface pour les experts
├── odyssey-expert-admin-dashboard.html     # Dashboard admin équipe produit
└── club-med-trident-design-tokens.css      # Design system (à copier depuis parent)
```
...
### Pour les experts opérationnels

1. **Ouvrir** : `odyssey-questionnaire-experts.html`
2. **S'identifier** : Remplir nom, email, rôle, localisation (resort/BU/siège)
3. **Répondre** : Parcourir les questions et répondre selon votre expertise
4. **Clarifier** : Utiliser la zone commentaires pour poser des questions
5. **Soumettre** : Vos réponses sont sauvegardées automatiquement
6. **Exporter** : Télécharger une copie JSON/CSV pour référence

### Pour l'équipe produit

1. **Ouvrir** : `odyssey-expert-admin-dashboard.html`
2. **Consulter** : Visualiser les KPIs et réponses de tous les experts
3. **Comparer** : Voir les réponses par question pour identifier consensus/divergences
4. **Exporter** : Télécharger en JSON/CSV/Markdown/Synthèse
5. **Valider** : Après validation, cliquer sur "Valider et mettre à jour" pour intégrer aux règles métier
